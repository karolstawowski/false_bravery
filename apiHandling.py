...
def get_image_from_api(source, source_type):
...
def get_rune_image_from_api(name, source, size, background_color):
...
def convert_png_to_jpg(image_name, png_image, size, background_color):
