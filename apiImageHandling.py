...
def get_image_from_api(source, source_type) -> Image:
...
def get_rune_image_from_api(name, source, size, background_color) -> Image:
...
def convert_png_to_jpg(image_name, png_image, size, background_color) -> Image:
