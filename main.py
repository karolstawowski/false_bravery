...
[mythic_items, legendary_items, boots_items] = get_items_from_api(
...
runDiscordBot(mythic_items, legendary_items, boots_items,
              champions, summoner_spells, primary_runes, rune_trees)
